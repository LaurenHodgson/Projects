...
cd /home/jc148322/scripts/hydrology

R CMD SHLIB Budyko.c
...
#START R
#the function
dyn.load("/home/jc148322/scripts/hydrology/Budyko.so")
...
PAWHC.asc = read.asc(paste(out.dir,'PAWHC_5km.asc', sep='')) #read in the base ascii grid file
kRs.asc = read.asc(paste(out.dir,'kRs_5km.asc', sep=''))
DEM_5km.asc = read.asc(paste(out.dir,'DEM_5km.asc', sep=''))
...
PAWHC.mat = pos; PAWHC.mat$PAWHCcur =
extract.data(cbind(pos$lon,pos$lat),PAWHC.asc)
kRs.mat = pos; kRs.mat$kRscur = extract.data(cbind(pos$lon,pos$lat),kRs.asc)
DEM_5km.mat = pos; DEM_5km.mat$DEM_5kmcur =
extract.data(cbind(pos$lon,pos$lat),DEM_5km.asc)
...
image.dir='/home/jc148322/Hydrology.trials/'
