...
# amphibia.avoid.gradient=read.asc.gz('Amphibia.avoid16.gradient.asc.gz')
# amphibia.sres.gradient=read.asc.gz('Amphibia.sresa1b.gradient.asc.gz')

# aves.avoid.gradient=read.asc.gz('Aves.avoid16.gradient.asc.gz')
# aves.sres.gradient=read.asc.gz('Aves.sresa1b.gradient.asc.gz')

# mammalia.avoid.gradient=read.asc.gz('Mammalia.avoid16.gradient.asc.gz')
# mammalia.sres.gradient=read.asc.gz('Mammalia.sresa1b.gradient.asc.gz')

# reptilia.avoid.gradient=read.asc.gz('Reptilia.avoid16.gradient.asc.gz')
...
# write.asc.gz(avoid.gradient, 'All.avoid16.gradient.asc')
...
avoid.gradient=read.asc.gz('animal_m.asc.gz')
...
plantae.avoid.gradient=read.asc.gz('plant_m.asc.gz')
...
png(paste('plants_animals_avoid16.png',sep=''), width=16.8, height=12, units='cm', res=300, pointsize=5, bg='white')
...
mtext('AVOID (A1B_A16r5l)', side=2, line=1, cex=1.5)
