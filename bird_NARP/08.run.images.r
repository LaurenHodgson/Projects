...
###################################
#read in threshold
spp.dir = paste('/home/jc165798/working/NARP_birds/',model.dir,'/',spp,'/',sep=''); setwd(spp.dir) 
...
png(paste(spp,'.png',sep=''),width=dim(base.asc)[1]*2+20, height=dim(base.asc)[2]*1+350, units='px', pointsize=20, bg='white')
	...
	image(current, ann=FALSE,axes=FALSE,col=cols, zlim=zlim, xlim=xlim,ylim=ylim,xpd=FALSE,add=TRUE)
