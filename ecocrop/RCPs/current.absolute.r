...
ecocrop.dir = "/home/jc148322/Ecocrop_output/RCPs/";dir.create(ecocrop.dir)
...
cropdata=read.csv(paste(out.dir,'ecocrop_new.csv',sep=''))
trialdata=cropdata[1:5,]
ECOcrops=trialdata
...
name=as.character(species.data$NAME)
