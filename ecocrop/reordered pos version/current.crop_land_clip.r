...
library(SDMTools)
out.dir ="/home/jc148322/Ecocrop_output/"; setwd(out.dir)
...
image(temp.asc, ann=FALSE,axes=FALSE, zlim=c(0,1), col=cols,add=TRUE)
...
image(base.asc,ann=FALSE,axes=FALSE, col='gray90')
image(rain.asc, ann=FALSE,axes=FALSE, zlim=c(0,1), col=cols,add=TRUE)
image(landuse.asc,ann=FALSE,axes=FALSE, col='gray90',add=TRUE)
