...
save(pos.temp, file=paste(out.dir, '2080temp_macadamia.rData', sep=''))
...
save(pos.rain, file=paste(out.dir, '2080rain_macadamia.rData', sep=''))
...
ph.asc = base.asc
ph.asc[cbind(pos.ph$row, pos.ph$col)] = copy.ph2$PH ####!!!! NEED TO CHANGE THIS BACK TO copy.ph range once shown jeremy the data.
####################################SALINITY
...
png(paste(out.dir, '/', species, '.', 'gcm.variability2.png',sep=''), width=16, height=14.5, units='cm', res=300, pointsize=5, bg='white')
