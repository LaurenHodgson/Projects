...
out.dir = "E:/Barra Work Directory/outputs/glencross/"

pnts=cbind(x=c(112,116,116,112), y=c(-11,-11,-18.5,-18.5))

cols = colorRampPalette(c('wheat3','wheat2','slategray2','slategray3','steelblue3','steelblue4'))(100)
zlim=c(0,3500)
...
png(paste(out.dir, 'current.gradent.website.png',sep=''), width=10, height=9, units='cm', res=300, pointsize=5, bg='transparent')
par(mar=c(0,1,0,1))
