...
png(paste(out.dir, 'all.test3.png',sep=''), width=14, height=14, units='cm', res=300, pointsize=5, bg='transparent')
par(mfrow=c(2,2), mar=c(3,5,5,2))
	plot(jul$day,jul$wt, ylim=c(0,5000), main="Julaten: Sept - April",  xaxt='n', xlab=NA, ylab="Weight (g)", type='n',  cex.main=2, cex.lab=1.7, cex.axis=1.7, col=cols[1])
	...
	plot(dtr$day,dtr$wt, ylim=c(0,5000), main="Daintree: Sept only",  xaxt='n', xlab=NA, ylab="Weight (g)", type='n',  cex.main=2, cex.lab=1.7, cex.axis=1.7, col=cols[1])
		...
		axis(1,at=c(1,182.5,365,547.5, 730),labels=c(NA,'6 months',NA, '18 months', NA),lwd=1,lwd.ticks=1.2, cex.axis=1.7)
	plot(inf$day,inf$wt, ylim=c(0,5000), main="Innisfail: Sept - April",  xaxt='n', xlab=NA, ylab="Weight (g)", type='n', cex.main=2, cex.lab=1.7, cex.axis=1.7, col=cols[1])
		...
		axis(1,at=c(1,182.5,365,547.5, 730),labels=c(NA,'6 months',NA, '18 months', NA),lwd=1,lwd.ticks=1.2, cex.axis=1.7)
	plot(mrb$day,mrb$wt, ylim=c(0,5000), main="Mareeba: Sept - April",  xaxt='n', xlab=NA, ylab="Weight (g)", type='n',  cex.main=2, cex.lab=1.7, cex.axis=1.7, col=cols[1])
